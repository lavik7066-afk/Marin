...
def create_stats_content(stats_data, selected):
    content_map = {
        ...
        "System Info": (
            ...
            f"**{MARIN_CODE} Software**\n"
            f"Python: **{sys.version_info.major}.{sys.version_info.minor}**\n"
            f"Discord.py: **{discord.__version__}**"
        ),
        "General Info": (
            f"**Uptime**: `{stats_data['uptime']}`\n\n"
            f"**{MARIN_GLOBAL} Server Stats**\n"
            f"Guilds: **{stats_data['guilds']}**\n"
            f"Users: **{stats_data['users']}**\n\n"
            f"**{MARIN_COMMAND} Commands Stats**\n"
        ...
        "Team Info": (
            ...
            f"**{MARIN_OWNER} Main Owner**\n"
            "[01]. [Lavish](https://discord.com/users/1321164186570592287)"
        ),
        "Code Info": (
            f"**{MARIN_SEARCH} Codebase Overview**\n\n"
