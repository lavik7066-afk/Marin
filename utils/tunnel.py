...
"""
HTTPS Tunnel for the Marin API — Cloudflare Tunnel via pycloudflared.
...
4. Give it a name (e.g. marin-api) and click Save
...
6. Go to "Published Application Routes" tab → Add a Published Application Routes:
    Subdomain: marin-api   Domain: yourdomain.com   Service: http://localhost:8000
   (Or use any domain you have on Cloudflare)
7. Paste the token into your .env:
      CF_TUNNEL_TOKEN = "eyJhIjoiX..."
    CF_TUNNEL_URL   = "https://marin-api.yourdomain.com"
...
def start_tunnel() -> None:
    ...
    Called from Marin2.py after keep_alive().
    """
